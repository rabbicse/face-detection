...
class InsectTrain:
    ...
    def load_dataset(self):
        ...
        train_dataset = torchvision.datasets.ImageFolder(root='../../data/hymenoptera_data/train',
                                                         transform=train_transforms)
        validation_dataset = torchvision.datasets.ImageFolder(root='../../data/hymenoptera_data/val',
                                                              transform=test_transforms)
        test_dataset = torchvision.datasets.ImageFolder(root='../../data/hymenoptera_data/test',
                                                        transform=test_transforms)
    ...
    def evaluate(self, iterator, best_val_acc, mode='test'):
        ...
        if epoch_acc > best_val_acc and mode == 'val':
            ...
            torch.save(self.net.state_dict(), "../models/insect_resnet50_best.pth")
    ...
    def train_data(self):
        ...
        # save model
        model_path = '../models/insect_net.pth'
